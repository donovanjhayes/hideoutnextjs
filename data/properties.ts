...
export const properties: Property[] = [
  {
    ...
    description: 'Escape to the Poconos in this cozy chalet, perfect for a large group with 3 floors of living space, a hot tub, a private deck, and a fireplace. Just minutes from skiing, swimming, and lakes. Check out our airbnb listing to see our reviews, but be sure to book directly with us for the best rates! https://airbnb.com/h/hideoutvacation',
  ...
  },
  {
    ...
    description: 'We can accommodate groups as large as 25... contact us directly for more information! You can contact us through the direct booking engine, or you can send us an email directly at retreats@hideoutvacation.com',
